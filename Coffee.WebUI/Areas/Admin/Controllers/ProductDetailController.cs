...
namespace Coffee.WebUI.Areas.Admin.Controllers
{
    ...
    public class ProductDetailController : Controller
    {
        ...
        public ProductDetailController(IRepository<ProductImage> repository, IRepository<Product> repositoryProduct, IRepository<Category> repositoryCate, IWebHostEnvironment environment)
        {
